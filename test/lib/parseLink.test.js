...
describe("parseLinks", function () {
  ...
  describe("swissmedic", function () {
    before(function () {
      ...
      html = fs.readFileSync(path.resolve(__dirname, "../../fixtures/swissmedic/index.html"), {encoding: "utf8"});
  ...
  describe("atc", function () {
    before(function () {
      ...
      html = fs.readFileSync(path.resolve(__dirname, "../../fixtures/atc/amtl_atc-code.html"), {encoding: "utf8"});
  ...
  describe("bag", function () {
    before(function () {
      ...
      html = fs.readFileSync(path.resolve(__dirname, "../../fixtures/bag/index.html"), {encoding: "utf8"});
